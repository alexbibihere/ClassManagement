                    ...
                    <div class="box-inner">
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                <thead>
                                <button class="btn btn-success" id="notice_add_btn">添加班级活动</button>
                                <br/>
                                <br/>
                                <tr>
                                    <th>活动内容</th>
                                ...
                                <c:forEach var="notice" items="${notice}">
                                    <tr>
                                        ...
                                        <td class="center">
                                            <button class="btn btn-info editbtn" id="${notice.id}">编辑</button>
                                            <button class="btn btn-danger delbtn" id="${notice.id}">删除</button>
